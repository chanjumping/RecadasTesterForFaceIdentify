...
class FaceWindow(object):
    ...
    def __init__(self, face, face_youwei):
        self.root_face = face
    ...
    def face_func_window(self):
        ...
        self.frame_su_para_case = Label(self.root_face,text="人脸信息用例：")
        self.frame_su_para_case.grid(row=4, column=0, pady=15, sticky=W)
        self.frame_su_para_select = Button(self.root_face, text="选择用例", command=self.select_case_file, bd=5, width=15)
